<h2><a href="https://www.geeksforgeeks.org/problems/find-unit-digit-in-a-product2059/0">Find unit digit in a Product</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given 6 numbers a,b,c,d,e,f. Find the last digit of (a<sup>b</sup>)*(c<sup>d</sup>)*(e<sup>f</sup>).</span></p>
